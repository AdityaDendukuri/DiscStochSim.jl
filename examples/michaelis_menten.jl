...
# ╔═╡ 7c26c18c-ed7b-11ef-31ae-c3d5c70da594
begin
	# numerical libraries
...
# ╔═╡ 1e1b45fd-92d5-47a0-9fe7-fbcfb91550ab
...
# ╔═╡ 9a3ed624-7994-4097-b6f1-50ea59299925
...
init_fsp_vars = begin
	global U₀ = CartesianIndex(50, 10, 1, 1);
	global 𝒮₀ = Set([U₀])
...
begin
	...
	jump_sol = solve(jprob; seed=1234)
...
uniform_time, ssa_mean = mean_trajectory(ssa_trajs1, 0.0, 200.0, length(T))

# ╔═╡ 2154f33b-829f-459e-9ca8-6b76184b54a9
begin
