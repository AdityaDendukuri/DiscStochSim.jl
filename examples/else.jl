...
# ╔═╡ 97c768a0-8b78-11f1-ab4e-6d4de0dd5b9b
begin
...
# ╔═╡ eaae01ed-72c4-40cf-b0d3-1a590fd713ad
begin
...
# ╔═╡ 0ab6c602-b8bd-45b2-b974-cf8d3fce36f0


# ╔═╡ a5fd5037-18f3-4aa7-8432-8bffe260361c
basin(G) = begin
...
# ╔═╡ 53e71436-82fd-4f9f-b0eb-228f1fda9938
# finds the bottom of the X-high well — the single most-likely state in that basin — which ELSE uses as its start p0 (and Gillespie uses as its initial condition).
...
# ╔═╡ 485a9121-8069-4bf3-a1ab-3aac97efdda1
# Z p0 = -inv(A_JJ) p0  
occupation(sub) = -(sub.A \ sub.p0)  

# ╔═╡ 55c60c23-b006-4734-beaf-052dbc34ddbe
# Variance / moments
...
# ╔═╡ 44d70805-36d1-4ad4-ac94-88a82a9cd833


# ╔═╡ 3a872674-404a-42e8-8bf9-66fa8313440f


# ╔═╡ b45ebcc9-fbbd-45d1-b545-7987cd482196


# ╔═╡ fd38a78b-4fd2-43ca-a176-32f255268f32
Ssurv(w, t) = real(sum(w.a .* exp.(w.λ .* t)))

# ╔═╡ 1567adcb-18c2-4d1d-acaf-ca9c2fdb0ea5
