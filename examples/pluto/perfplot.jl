...
# ╔═╡ 7a61a250-add2-11f0-b044-adf2ed39ace3
begin
	using JLD
	using CairoMakie
	using LaTeXStrings
...
# ╔═╡ a5d9ebd4-5db7-48e7-869f-73b3f459e3e6
begin
	global siam_theme = Theme(
		    fontsize = 10,
		    font = "CMU Serif",
...
# ╔═╡ ddf256de-acc2-4527-9ce6-b4793bcb2fda
begin
	@load "../orag_times1.jld"
...
# ╔═╡ 390eb6fb-414d-461a-92d0-40e6190550b4
begin
	@load "ts_opt.jld"
	@load "ts_nopt.jld"
	global tms_opt = tms1
	global tms_nopt = tms2
end

# ╔═╡ 18bd414b-415f-4c37-9cd3-fc72a2931269


# ╔═╡ 25ab7bb8-8b4b-4fce-a80b-c4c3ba52dbf1
begin
	@load "../rober_opt.jld"
	@load "../rober_nopt.jld"
	@load "../rober_dt.jld"
	
	global rober_opt = tim1 
	global rober_nopt = tim
	#@save "../rober_dt" rober_dt
end

# ╔═╡ 5f27cb55-eaef-4a2a-b1ec-4f1ed0153982
begin
	...
	lines!(ax_a, sol_t_orag[2:end],orag1, color = :black, linestyle = :dot)
	lines!(ax_a, sol_t_orag[2:end],orag2, color = :black, linestyle = :solid)
	...
	lines!(ax_b, sol_t[2:end],rober_nopt, color = :black, linestyle = :dot)
	lines!(ax_b, sol_t[2:end],rober_opt, color = :black, linestyle = :solid)
	...
	lines!(ax_c, tms_opt, color = :black, linestyle = :dot, label="un-optimized")
	lines!(ax_c, tms_nopt, color = :black, linestyle = :solid, label="optimized")
	axislegend(ax_c, position=:rc)
	# Uniform layout adjustments
...
# ╔═╡ ccbc731b-a36b-4a07-abc9-a5b6dd6d9dbf
sum(rober_opt)

# ╔═╡ 15441438-5aac-4f07-b740-8f05dc58f31a
save("speed.pdf", fig)
...
manifest_format = "2.0"
project_hash = "db2677df252458ec49ee19ccc42f1e59e9d4c9d7"
