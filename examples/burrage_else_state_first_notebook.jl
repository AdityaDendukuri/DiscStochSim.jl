...
# ╔═╡ d4000008-4000-4000-8000-000000000008
md"""
`basin_for` is the only rule connecting one ELSE step to the next. The generic
sampler does not assume two basins or force alternation.
"""
